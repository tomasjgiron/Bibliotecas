...
int isAlphanumeric (char* pStr)
{
    ...
    while(pStr[i]!='\0')
    {
        if((pStr[i]!=' ')&&(pStr[i]!='.')&&(pStr[i]!='_')&&(pStr[i]!='-')&&
                (pStr[i]<'a'||pStr[i]>'z')&&(pStr[i]<'A'||pStr[i]>'Z')&&
                (pStr[i]<'0' || pStr[i]>'9'))
        {
            return 0;
        }
...
/** \brief Valida fechas con barras
* \param array de char
* \return retorna 1 diciendo que no hay error
*/
int isFechaBarra(char* pStr)
{
    ...
    while(pStr[i] != '\0')
    {
        if((pStr[0] < 1 || pStr[0] > 3) && (pStr[1] < 1 || pStr[1] > 9) && (pStr[2] != '/') &&
                (pStr[3] < '0' || pStr[3] > '1') && (pStr[4] < '0' || pStr[4] > '9') && (pStr[5] != '/') &&
                (pStr[6] < '1' || pStr[6] > '2') && (pStr[7] == '0' || pStr[7] == '9') && (pStr[8] < '0' || pStr[8] > '9') &&
                (pStr[9] < '0' || pStr[9] > '9'))
        {
            return ret;
        }
...
int isCelular(char* pStr)
{
    ...
    if(strlen(pStr) != 12) /// 11-4088-6301
    {
        return ret;
    }
    while(pStr[i] != '\0')
    {
        if((pStr[0] != '1') && (pStr[1] == '1' || pStr[1] == '5') && (pStr[2] != '-') &&
                (pStr[3] < '0' || pStr[3] > '9') && (pStr[4] < '0' || pStr[4] > '9') && (pStr[5] < '0' || pStr[5] > '9') &&
                (pStr[6] < '0' || pStr[6] > '9') && (pStr[7] != '-') && (pStr[8] < '0' || pStr[8] > '9') &&
                (pStr[9] < '0' || pStr[9] > '9') && (pStr[10] < '0' || pStr[10] > '9') &&
                (pStr[11] < '0' || pStr[11] > '9'))
        {
            return ret;
        }
